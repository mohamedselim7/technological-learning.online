...
class UserController extends Controller
{
    ...
    {
        // جلب جميع الإجابات مع الأسئلة المرتبطة
        $answers = $user->testResults()->with('answers.question')->get()->flatMap(function($result) {
            return $result->answers;
        });

        return view('admin.users.answers-web', compact('user', 'answers'));
    }
}
